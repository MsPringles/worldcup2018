...
<!-- Start: Theme Preview Pane -->
 ...
 <ul class="nav navbar-nav navbar-right">
        ...
        <li class="hidden-xs">
                     <a href="<?php echo Url::to(['wcup-admin/logout']) ?>" data-method="post">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown menu-merge">
          <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
          	...
          	<span class="hidden-xs pl15"> <?= Yii::$app->user->identity->admin_id ?> </span>
                          <?php  } ?>
            ...
            <div class="media">
              ...
              <div class="media-body">
                <div class="media-links">
                   <a href="#" class="sidebar-menu-toggle">用户菜单-</a> <a href="<?php echo Url::to(['wcup-admin/login']) ?>" data-method="post">登录 </a>
                </div>
                <?php  if(!Yii::$app->user->isGuest) { ?>
                <div class="media-author"><?= Yii::$app->user->identity->admin_id ?> </div>
              <?php  } ?>
              </div>
            </div>
          </div>
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            <a class="accordion-toggle" href="<?php echo Url::to(['department/index']) ?>">
              ...
              <span class="sidebar-title">管理员模块</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['wcup-admin/signup']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 注册管理员信息</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-admin/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 修改管理员信息</a>
              </li>
            </ul>
          </li>  
          <li>
            <a class="accordion-toggle" href="<?php echo Url::to(['batch/index']) ?>">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">用户模块</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['user/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 删除用户</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-comment/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 删除用户评论</a>
              </li>
            </ul>
          </li>
          <li>
            <a class="accordion-toggle" href="<?php echo Url::to(['level-index/index']) ?>">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">世界杯模块</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['wcup-country/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 入围国家</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-player/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 球员信息</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-record/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 比赛记录</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-ground/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 场地信息</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-top/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 射手榜</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-judge/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 裁判信息</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-statistics/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 统计信息</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['wcup-champion/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 历届冠军</a>
              </li>
              <!-- <li>
          ...
          <li>
            <a class="accordion-toggle" href="<?php echo Url::to(['department/index']) ?>">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">关于我们</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['wcup-admin/about']) ?>"  target="_blank">
                  <span class="glyphicon glyphicon-book"></span> 是彩蛋鸭（是作业鸭</a>
              </li>
            </ul>
          </li>  
          ...
          <li class="sidebar-label pt25 pb10">小可爱鸭</li>
          <li class="sidebar-stat">
            <a href="#projectOne" class="fs11">
              <span class="fa fa-inbox text-info"></span>
              <span class="sidebar-title text-muted">超级无敌可爱</span>
          ...
          <li class="sidebar-stat">
            <a href="#projectOne" class="fs11">
              ...
              <span class="sidebar-title text-muted">宇宙可爱</span>
